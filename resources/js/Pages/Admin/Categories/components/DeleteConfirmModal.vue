...
<template>
    <Teleport to="body">
        <Transition enter-active-class="transition duration-150 ease-out" enter-from-class="opacity-0" enter-to-class="opacity-100"
            ...
            <div v-if="subject !== null && subject !== undefined"
                ...
                <Transition enter-active-class="transition duration-150 ease-out" enter-from-class="opacity-0 scale-95"
                    ...
                    <div v-if="subject !== null && subject !== undefined"
                        ...
                        style="background: linear-gradient(135deg, rgba(255,255,255,0.07) 0%, rgba(255,255,255,0.02) 100%);
                               backdrop-filter: blur(24px); border: 1px solid rgba(251,113,133,0.15);
                        ...
                        <h3 class="font-display text-lg font-semibold text-white">Delete {{ label }}?</h3>
                        <p class="mx-auto mt-2 max-w-[28ch] text-sm leading-relaxed text-white/45">
                            <span class="text-white/70">{{ subject }}</span> will be permanently removed.
                        </p>
