            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <h3 class="font-display text-lg font-semibold text-white">Remove admin?</h3>
                        <p class="mx-auto mt-2 max-w-[28ch] text-sm leading-relaxed text-white/45">
                            <span class="text-white/70">{{ user.name }}</span> will lose all admin access immediately.
                        </p>

                        <div class="my-5 h-px"
                            style="background: linear-gradient(90deg, transparent, rgba(255,255,255,0.06), transparent);"></div>
